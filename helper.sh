#!/bin/sh
# original file from Guilouz Creality Helper Script. Forked and edited by MikeinRedding 
# to add BttEddy and a few other functions
set -e
clear
...
rm -rf /root/.cache
set_paths #scripts\paths.sh
set_permissions #scripts\paths.sh
#update_menu
main_menu #scripts\menu\main_menu.sh
